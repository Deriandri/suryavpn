...
data class SavedConfig(
    ...
    // DNS custom untuk TUN interface. Kosong = tidak ada DNS per-profil -- lihat
    // VpnSettings.dnsFallbackEnabled/defaultDns (kartu VPN Setting) untuk fallback
    // opsional (mati & kosong secara default, tidak ada hardcode bawaan lagi).
